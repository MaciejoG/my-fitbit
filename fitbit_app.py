...
try:
    ...
    print("Will update data for " + str((today-last_entry_date).days-1) + " days")
...
# Get activity data - WITH HALF DATES
...
# # Insert activity data into pandas df - WITH HALF-DATES
...
# !jupyter nbconvert --to script fitbit_app.ipynb
